...
def build_condition_signals(features: pd.DataFrame) -> pd.DataFrame:
    ...
    matched = frame[frame["condition_labels"].ne("")].copy()
    matched = matched.reindex(columns=CONDITION_COLUMNS)
